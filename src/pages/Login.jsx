  ...
  return (
    <div className="min-h-screen bg-background flex flex-col overflow-x-hidden">
      ...
      <div className="fixed inset-0 z-0 pointer-events-none overflow-hidden">
        <div className="absolute top-1/4 left-1/2 -translate-x-1/2 w-[700px] h-[700px] bg-primary/4 rounded-full blur-[140px]" />
      ...
      <main className="relative z-10 flex-grow flex items-center justify-center px-md pt-28 pb-xl">
        <div className="w-full max-w-[460px]">
          ...
          {/* Card */}
          <div className="glass-card rounded-2xl p-xl flex flex-col gap-lg" style={{ boxShadow: '0 0 60px rgba(192,193,255,0.08), 0 0 120px rgba(192,193,255,0.04)' }}>
            ...
            <div className="grid grid-cols-2 gap-md">
              <button className="flex items-center justify-center gap-sm py-sm px-md border border-white/8 rounded-xl hover:bg-white/5 hover:border-white/15 transition-all active:scale-[0.98] text-sm">
          ...
          {/* Social proof */}
          <div className="mt-xl flex items-center justify-center gap-md text-xs font-mono text-on-surface-variant">
            <div className="flex -space-x-2">
              {['#c0c1ff', '#4cd7f6', '#ffb783', '#c0c1ff'].map((color, i) => (
                <div key={i} className="w-6 h-6 rounded-full border-2 border-background" style={{ background: color, opacity: 0.8 }} />
              ))}
            </div>
